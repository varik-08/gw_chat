...
const (
	...
	ChatService_GetMembersIDsByChatID_FullMethodName = "/chat.v1.ChatService/GetMembersIDsByChatID"
)
...
type ChatServiceClient interface {
	...
	GetMembersIDsByChatID(ctx context.Context, in *GetMembersIDsByChatIDRequest, opts ...grpc.CallOption) (*GetMembersIDsByChatIDResponse, error)
}
...
func (c *chatServiceClient) GetMembersIDsByChatID(ctx context.Context, in *GetMembersIDsByChatIDRequest, opts ...grpc.CallOption) (*GetMembersIDsByChatIDResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetMembersIDsByChatIDResponse)
	err := c.cc.Invoke(ctx, ChatService_GetMembersIDsByChatID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChatServiceServer interface {
	...
	GetMembersIDsByChatID(context.Context, *GetMembersIDsByChatIDRequest) (*GetMembersIDsByChatIDResponse, error)
...
func (UnimplementedChatServiceServer) GetMembersIDsByChatID(context.Context, *GetMembersIDsByChatIDRequest) (*GetMembersIDsByChatIDResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMembersIDsByChatID not implemented")
}
...
func _ChatService_GetMembersIDsByChatID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetMembersIDsByChatIDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServiceServer).GetMembersIDsByChatID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChatService_GetMembersIDsByChatID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).GetMembersIDsByChatID(ctx, req.(*GetMembersIDsByChatIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ChatService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetMembersIDsByChatID",
			Handler:    _ChatService_GetMembersIDsByChatID_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "chat.v1.proto",
}
